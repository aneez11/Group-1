...
<div class="container-fluid main-box">
	<div class="white-paper mt-3 p-4 w-100">
		<div class="container-fluid row">
			
				<h3 class="sujanh1" >Stores on Pricena</h3>
		...
		<div class="sujanrow row">
			<div class= "col-md-2">
				...
				<a class="sujana"class="sujana" href="#">Amazon AE</a>
			...
			<div class= "col-md-2">
				...
				<a class="sujana"href="#">Mamas & Papas</a>
				<span class="fa fa-star checked"></span>
				<span class="fa fa-star checked"></span>
				<span class="fa fa-star checked"></span>
				<span class="fa fa-star"></span>
			...
			<div class= "col-md-2">
				...
				<a class="sujana" href="#">Sharaf DG</a>
				<span class="fa fa-star checked"></span>
				<span class="fa fa-star checked"></span>
				<span class="fa fa-star checked"></span>
				<span class="fa fa-star"></span>
			...
			<div class= "col-md-2">
				...
				<a class="sujana"href="#">Virgin Megastone</a>
				<span class="fa fa-star checked"></span>
				<span class="fa fa-star checked"></span>
				<span class="fa fa-star checked"></span>
				<span class="fa fa-star"></span>
